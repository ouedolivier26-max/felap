    ...
    <div class="grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="mt-1 text-sm text-gray-600">Administrateur</p>
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="nom_entreprise" value="{{ old('nom_entreprise', $admin->nom_entreprise ?? '') }}" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-700 outline-none transition focus:border-gray-400 focus:bg-white @error('nom_entreprise') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="description" value="{{ old('description', $admin->description ?? '') }}" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-700 outline-none transition focus:border-gray-400 focus:bg-white @error('description') border-red-500 @enderror">
                        @error('description')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
